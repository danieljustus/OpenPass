...
- Reporting security vulnerabilities through proper channels (see [SECURITY.md](SECURITY.md))
...
- Introducing malicious code, backdoors, or other security hazards into the project
...
Project maintainers will follow these guidelines when determining consequences for violations:

1. **Correction**: A private, written message providing clarity around the nature of the violation.
2. **Warning**: A public warning with expectations for behavior change.
3. **Temporary Ban**: A temporary ban from project participation or communication channels.
4. **Permanent Ban**: A permanent ban from the project and all associated spaces.
