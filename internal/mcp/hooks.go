...
type PreCallHook func(ctx context.Context, toolName string, args CallToolRequest, server *Server) (context.Context, error)
...
type PostCallHook func(ctx context.Context, toolName string, args CallToolRequest, result *CallToolResult, err error) (*CallToolResult, error)
